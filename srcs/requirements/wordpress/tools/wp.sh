...
wp core install --allow-root --url=${DOMAIN_NAME} --title=${WP_TITLE} --admin_user=${MYSQL_USER} --admin_password=${MYSQL_USER_PASSWORD} --admin_email=${WP_ADMIN_EMAIL} --skip-email
